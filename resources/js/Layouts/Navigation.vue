...
<template>
    <aside class="z-20 hidden w-64 overflow-y-auto bg-white md:block flex-shrink-0">
        <div class="py-4 text-gray-500">
            <Link class="px-2 flex text-center text-lg font-bold text-gray-800" :href="route('dashboard')">
                <ApplicationLogo class="px-2 block h-9 w-auto fill-current text-gray-800"/>
                Администратор
            </Link>
