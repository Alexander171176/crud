                ...
                <div class="min-h-screen h-full flex flex-col after:flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                            ...
                            <div class="text-sm">
                                Have an account?
                                <router-link class="font-medium text-indigo-500 hover:text-indigo-600" to="/signin">Sign
                                    In
                                </router-link>
                            </div>
                        </div>
                    ...
                    <div class="px-4 py-8">
                        <div class="max-w-md mx-auto">
                            ...
                            <div class="text-center">
                                ...
                                <router-link class="btn bg-indigo-500 hover:bg-indigo-600 text-white" to="/">Go To
                                    Dashboard -&gt;
                                </router-link>
                            </div>
